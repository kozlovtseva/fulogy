...
class Header extends Component {
  ...
  render() {
    let menu = this.state.modal ? <Menu /> : null;
    return (
      <div className={styles.Container}>
        <div className={styles.Logo}>
          <svg height="70px" viewBox="-4.875 18.75 82.125 34.375">
            <path
              fill="#fff"
        ...
        <div className={styles.Items}>
          ...
          <div className={styles.Icon} onClick={() => this.toggleModal()}>
            <div
              className={
                this.state.modal
                  ? styles.Burger + " " + styles.NonActive
                  : styles.Burger
              }
            />
            <div
              className={
                this.state.modal
                  ? styles.Cancel
                  : styles.Cancel + " " + styles.NonActive
              }
            />
          </div>
        </div>
